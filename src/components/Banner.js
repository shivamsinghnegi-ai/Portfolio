...
export const Banner = () => {
  ...
  const onButtonClick = () => {
    const pdfUrl = "https://drive.google.com/file/d/1eNvbQ6L5CTU8SukInfTGvdD_uvq74-mb/view?usp=sharing";
  ...
  const onButtonClick1 = () => {
    const pdfUrl = "https://www.linkedin.com/in/shivam-singh-negi-222853311";
    const link = document.createElement("a");
    link.href = pdfUrl;
    document.body.appendChild(link);
    link.click();
